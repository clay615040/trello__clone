...
export default {
  ...
  mutations: {    
    ...
    RECEIVING_REPORT(state, req) {
        ...
        state.request.revenue.vendor_code = req.vendorCode;                
        state.request.revenue.game_id = req.gameId;
        state.request.revenue.date = req.date;   
    },
  ...
  actions: {
    ...
    request_report({commit}, req) {
        ...
        return new Promise(async(resolve, reject) => {                
            ...
            let _res = await axios.post('/api/dailyGamePopular', { 'data':_data, 'hash':_hash });
