<template>
  <section :class="{
    ...
    <div v-if="!customControls && mainControls"
      ...
      <a v-if="settings || settingsInverse" href="#"><i class="la la-cog" aria-hidden="true"></i></a>
      <a @click="loadWidgster($event)" v-if="refresh" href="#" :id="`reloadId-${randomId}`">
        ...
        <i v-else class="la la-refresh" aria-hidden="true"></i>
          <b-tooltip
            v-if="showTooltip"
      ...
      <a v-if="close" href="#" @click="closeWidget($event)" :id="`closeId-${randomId}`">
        ...
        <i v-else class="la la-remove" aria-hidden="true"></i>
        <b-tooltip
          v-if="showTooltip"
          :placement="tooltipPlacement"
